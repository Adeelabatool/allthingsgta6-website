...
export const Route = createFileRoute("/wiki/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The structured GTA 6 wiki: characters, map locations, vehicles, weapons, gangs and companies — encyclopedia-style, sourced and updated." },
  ...
  return (
    <SiteShell>
      <header className="container-page pt-10 pb-6">
        ...
        <p className="mt-2 text-muted-foreground max-w-2xl">Encyclopedia-style entries on every confirmed and speculated element of Grand Theft Auto VI.</p>
      </header>
          ...
          return (
            <section key={t.slug}>
              ...
              <div className="grid gap-3 md:grid-cols-3">
                {entries.map((w) => (
                  <Link key={w.slug} to="/wiki/$type/$slug" params={{ type: w.type, slug: w.slug }} className="surface surface-hover p-4">
