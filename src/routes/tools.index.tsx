...
export const Route = createFileRoute("/tools/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Interactive GTA 6 tools: countdown to release, hype calculator, vehicle comparator, and interactive map." },
...
const tools = [
  { href: "/tools/countdown", icon: "⏳", title: "Countdown Timer", desc: "Live countdown to November 19, 2026." },
  { href: "/tools/hype-calculator", icon: "📈", title: "Hype Calculator", desc: "Score your personal GTA 6 hype level." },
  { href: "/tools/vehicle-comparator", icon: "🏎️", title: "Vehicle Comparator", desc: "Compare vehicle specs side-by-side." },
  { href: "/tools/map", icon: "🗺️", title: "Map Tool", desc: "Interactive Vice City map (preview)." },
] as const;
  ...
  return (
    <SiteShell>
      <header className="container-page pt-10 pb-6">
        ...
        <p className="mt-2 text-muted-foreground max-w-2xl">Play with the data. Compare, calculate, and count down.</p>
      </header>
